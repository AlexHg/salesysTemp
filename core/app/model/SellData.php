...
class SellData {
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (total,discount,user_id,created_at,local_id) ";
		$sql .= "value ($this->total,$this->discount,$this->user_id,$this->created_at,$this->local_id)";
		return Executor::doit($sql);
	}

	public function add_re(){
		$sql = "insert into ".self::$tablename." (user_id,operation_type_id,created_at,local_id) ";
		$sql .= "value ($this->user_id,1,$this->created_at,$this->local_id)";
		return Executor::doit($sql);
	}


	public function add_with_client(){
		$sql = "insert into ".self::$tablename." (total,discount,person_id,user_id,created_at,local_id) ";
		$sql .= "value ($this->total,$this->discount,$this->person_id,$this->user_id,$this->created_at,$this->local_id)";
		return Executor::doit($sql);
	}

	public function add_re_with_client(){
		$sql = "insert into ".self::$tablename." (person_id,operation_type_id,user_id,created_at,local_id) ";
		$sql .= "value ($this->person_id,1,$this->user_id,$this->created_at,$this->local_id)";
		return Executor::doit($sql);
	}
